...
namespace Eval {
    ...
    constexpr inline Score queen_mobility[28] = {
        ...
        { -5, -10}, {  0,  -5}, {  0,   0}, {  5,   5},
        {  5,  10}, { 10,  15}, { 10,  20}, { 15,  25},
        { 15,  30}, { 20,  35}, { 20,  40}, { 25,  45},
        { 25,  45}, { 25,  45}, { 25,  40}, { 20,  35},
        { 20,  30}, { 15,  25}, { 10,  20}, {  5,  10},
        {  0,   5}, { -5,   0}, {-10,  -5}, {-15, -10}
    };
